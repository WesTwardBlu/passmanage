...
$(document).ready(function(){
	...
	$.ajax({type:'post',url:'/passmanage/passinfo/selectpassinfobycid',data:{cid:1},success:function(data){
...
//			txt3.innerHTML="Text.";
	...
	$("tbody").on('click','tr.gradeA',function(){
			...
			location.href='/passmanage/charts-detail.html?pid='+ $(this).find('input').val();
	});
});
