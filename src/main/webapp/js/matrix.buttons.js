...
$(document).ready(function(){
	...
	$.ajax({type:'post',url:'/passmanage/passinfo/selectpassinfobycid',data:{cid:6},success:function(data){
	...
	$("tbody").on('click','tr.gradeA',function(){
			...
			location.href='/passmanage/buttons-detail.html?pid='+ $(this).find('input').val();
	});
});
