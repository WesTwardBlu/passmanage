...
$(document).ready(function(){
	...
	$.ajax({type:'post',url:'/passmanage/passinfo/selectpassinfobycid',data:{cid:4},success:function(data){
	...
	$("tbody").on('click','tr.gradeA',function(){
			...
			location.href='/passmanage/grid-detail.html?pid='+ $(this).find('input').val();
	});
});
