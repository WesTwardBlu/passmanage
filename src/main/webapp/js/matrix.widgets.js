...
$(document).ready(function(){
	...
	$.ajax({type:'post',url:'/passmanage/passinfo/selectpassinfobycid',data:{cid:2},success:function(data){
	...
	$("tbody").on('click','tr.gradeA',function(){
			...
			location.href='/passmanage/widgets-detail.html?pid='+ $(this).find('input').val();
	});
});
